<template lang="pug">
component(:is="computed_component" :as="button ? 'button' : undefined" :type="button ? 'button' : undefined" @click="$emit('click')" :color="color" :hover-color="hoverColor" :active-color="activeColor" )
  svg.icon(
    :height="height ?? size"
    :style="styles"
    :width="width ?? size"
...
export default defineComponent({
    ...
    computed: {
        ...
        computed_component() {
            if (this.$props.color || this.$props.activeColor || this.$props.hoverColor || this.$props.button) {
                return 'v-text'
            }
